...
@NamedQuery(name = "Notification.countUnreadByUserId",
    query = "SELECT COUNT(n) FROM Notification n WHERE n.userId = :userId AND n.status NOT IN ('READ', 'EXPIRED', 'CANCELLED', 'FAILED')")
